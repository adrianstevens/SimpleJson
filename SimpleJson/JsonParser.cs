...
internal class JsonParser
{
            ...
            else if (c == '\\')
            {
                ...
                else if (c == 'u')
                {
                    ...
                    if (remainingLength >= 4)
                    {
                        ...
                        if (!(success = UInt32Extensions.TryParse(new string(json, index, 4), NumberStyle.Hexadecimal, out uint codePoint)))
                        {
                            return string.Empty;
                        }
    ...
    /// <returns></returns>
    protected static object ParseNumber(char[] json, ref int index, ref bool _)
    {
        EatWhitespace(json, ref index);
